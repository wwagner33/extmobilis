...
public class ListaCursos extends Activity implements OnItemClickListener {
	...
	private String[] nomeCursos = { "Química", "Matemática", "Biologia",
			"História", "Engenharia", "Mecânica", "Engenharia", "Química",
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		// intent = new Intent(ListaCursos.this,ListaPosts.class); // udar pra
		// lista de Tópicos
